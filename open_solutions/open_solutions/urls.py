...
from shop.views import (ProductListView,ProductDetailView, BasketView, OrderConfirmView, OrdersView, OrderDetailView, HomeAPIView)
...
urlpatterns = [
    ...
    path('api/v1/order/confirm/', OrderConfirmView.as_view()),
